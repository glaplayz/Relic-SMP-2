...
public class ImposterCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) {
            sender.sendMessage("\u00A7cUsage: /imposter <start [imposters]|stop|join|leave|status|give-task-item>");
            return true;
        }
        ...
        switch (args[0].toLowerCase()) {
            ...
            default -> sender.sendMessage("\u00A7cUsage: /imposter <start [imposters]|stop|join|leave|status|give-task-item>");
        }
        return true;
    }
